...
// 47-53 km
double _lapseRate3 = -0.00045; // Lapse rate in = 53-79 km
//	79-90 km
...
*_kinematicViscosity;
unsigned int step= 100; //Insteps of 100
...
{
    //Computing flow: Viscous, compressible flows
    //Initial conditions on all points= sea level settings: density, velocity, temperature, viscosity, kinematic
    //time step= 0
