...
int main ( int argc, char* argv[] )
{
    ...
    QString resTutDir = ApplicationWindow::getIEResourceDir();
    ...
    isOK = strTutTrans.load( "Interface-string", resTutDir );
    if( isOK )
    ...
    mw->setWindowTitle( QObject::tr( "Fight Tech Aerodynamics" ) );
